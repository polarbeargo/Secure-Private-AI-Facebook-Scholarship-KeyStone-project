...
* Reading [The Algorithmic Foundations of Differential Privacy](https://www.cis.upenn.edu/~aaroth/Papers/privacybook.pdf) to Definition 3.6 The sparse vector technique.
* Continue learning, watching and implement fastai https://www.fast.ai/.
...
* Reading AI for Trading Nanodegree Program to lesson 4.3 Better Learning - By Sleeping and
...
* Reading [PySyft tutorial](https://github.com/OpenMined/PySyft/blob/dev/examples/tutorials/Part%207%20-%20Federated%20Learning%20with%20Federated%20Dataset.ipynb) to Part 7 - Federated Learning with FederatedDataset.
...
* Attended virtual Meetup #sg_mumbai planning on having revision sessions the coming week :blush:.
* Shoutout @channel who don't yet complete the course, lets help them and encourage them for complete the course, I u guys can join with us on revision the whole courses from Wednesday :blush:
#60daysofudacity
![][image69]
...
* Receved Dan's email from Kaggle it's very warm and cute "Congratulations, you’ve made progress on our ML courses and have officially qualified for our beginner-friendly, invite-only ML competition! I feel been appreciate by Kaggle and Scholarship classmates all love Kaggle learn, I also love Kaggle's Youtube where I listen and learn things from. I love them and thank you for the warm emails I received. The competition will launch on August 29, but first we’d like to offer you the opportunity to sign up to be placed on a team with 3 - 4 other learners." We love Dan's email!! Thank you, Meghan and Rachel's SQL summer camp, I have fun times to have same memories with scholarship classmates thank you Udacity!
